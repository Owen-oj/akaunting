...
class Settings extends Controller
{
    ...
    public function edit()
    {
        ...
        $pay_items = PayItem::where('company_id', session('company_id'))->get();

        $pay_types = [
            'benefit' => trans('payroll::settings.type.benefit'),
            'deduction' => trans('payroll::settings.type.deduction')
            //  'tax' => trans('payroll::settings.type.tax'),
            //  'non_taxable' => trans('payroll::settings.type.non_taxable')
        ];
    ...
    public function payItemDestroy(PayItem $payItem)
    {
        $payItem->delete();
    ...
    public function payItemEdit(PayItem $payItem)
    {
        ...
        $html = view('payroll::modals.settings.pay-item-edit', compact('payItem', 'amount_types', 'pay_types'))->render();
