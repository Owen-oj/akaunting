...
@section('content')
    ...
    {!! Form::open([
        ...
        '@keydown' => 'apporal_form.errors.clear($event.target.name)',
        'files' => true,
        'role' => 'form',
        ...
        <div class="card card-default">
            <div class="card-body">
                {{ Form::dateGroup('payment_date', trans('payroll::run-payrolls.payment_date'), 'calendar',['id' => 'payment_date','required' => 'required', 'class' => 'form-control datepicker', 'date-format' => 'Y-m-d', 'autocomplete' => 'off', 'v-model' => 'apporal_form.payment_date', 'v-error' => 'apporal_form.errors.get("payment_date")', 'v-error-message' => 'apporal_form.errors.get("payment_date")'], $runPayroll->payment_date) }}
            </div>
        </div>
