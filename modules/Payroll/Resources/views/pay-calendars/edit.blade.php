        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    ...
                    {{ Form::selectGroup('type', trans_choice('general.types', 1), 'bars', $types, $pay_calendar->type, ['required' => 'required', 'change' => 'onChangeType']) }}
                    ...
                    <div class="form-group col-md-6 required d-none" :class="[{'has-error': {{ 'form.errors.get("pay_day")' }} }, {'show': field.pay_day}]">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            {!! Form::text('pay_day', $pay_calendar->pay_day, array_merge([
                                'class' => 'form-control',
...
@push('scripts_start')
    <script type="text/javascript">
        var default_data = {
            ...
            pay_day_mode_options: {!! json_encode($pay_day_modes) !!},
        };
    </script>
