...
@section('new_button')
    @permission('create-payroll-pay-calendars')
        <span class="new-button">
            <a href="{{ route('payroll.pay-calendars.create') }}" class="btn btn-success btn-sm">
                <span class="fa fa-plus"></span> &nbsp;{{ trans('general.add_new') }}
            </a>
        </span>
        <span>
            <a href="{{ route('import.create', ['payroll', 'pay-calendars']) }}" class="btn btn-white btn-sm header-button-top">
                <span class="fa fa-upload "></span> &nbsp;{{ trans('import.import') }}
            </a>
        </span>
    @endpermission
    <span>
        <a href="{{ route('payroll.pay-calendars.export', request()->input()) }}" class="btn btn-white btn-sm header-button-top">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                        ...
                                        @permission('delete-payroll-pay-calendars')
                                            <div class="dropdown-divider"></div>
                                            {!! Form::deleteLink($item, 'payroll.pay-calendars.destroy') !!}
                                        @endpermission
                                    </div>
                                </div>
                            </td>
...
@push('scripts_start')
    <script src="{{ asset('modules/Payroll/Resources/assets/js/pay-calendars.min.js?v=' . version('short')) }}"></script>
@endpush
