{!! Form::open([
    ...
    <div class="card">
        <div class="card-body">
            <div class="row">
                {{ Form::dateGroup('from_date', trans('payroll::run-payrolls.from_date'), 'calendar', ['id' => 'from_date', 'required' => 'required', 'data-inputmask' => '\'alias\': \'yyyy-mm-dd\'', 'data-mask' => '', 'autocomplete' => 'off'], Date::now()->toDateString(), 'col-md-4') }}

                {{ Form::dateGroup('to_date', trans('payroll::run-payrolls.to_date'), 'calendar', ['id' => 'to_date', 'required' => 'required', 'data-inputmask' => '\'alias\': \'yyyy-mm-dd\'', 'data-mask' => '', 'autocomplete' => 'off', 'min-date' => 'form.from_date'], Date::now()->toDateString(), 'col-md-4') }}

                {{ Form::dateGroup('payment_date', trans('payroll::run-payrolls.payment_date'), 'calendar', ['id' => 'payment_date', 'required' => 'required', 'data-inputmask' => '\'alias\': \'yyyy-mm-dd\'', 'data-mask' => '', 'autocomplete' => 'off'], Date::now()->toDateString(), 'col-md-4') }}
            </div>
        </div>
    </div>
