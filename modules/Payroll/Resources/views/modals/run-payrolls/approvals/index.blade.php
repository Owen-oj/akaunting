{!! Form::open([
    ...
    <div class="card card-default">
        <div class="card-body">
            {{ Form::dateGroup('payment_date', trans('payroll::run-payrolls.payment_date'), 'calendar',['id' => 'payment_date','required' => 'required', 'class' => 'form-control datepicker', 'date-format' => 'Y-m-d', 'autocomplete' => 'off'], $runPayroll->payment_date) }}
        </div>
    </div>
            ...
            <table class="table table-flush table-hover">
                ...
                <tbody>
                    ...
                    <tr class="row align-items-center border-top-1">
                            <td class="col-md-2 border-0"><a href="{{ route('payroll.employees.show', $item->id ) }}">{{ $item->employee->contact->name }}</a></td>
