                        ...
                        {!! Form::open([
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    {{ Form::selectAddNewGroup('category', trans_choice('general.categories', 1), 'folder', $categories, setting('payroll.category')) }}
...
@push('scripts_start')
<script src="{{ asset('modules/Payroll/Resources/assets/js/payroll-settings.min.js?v=' . version('short')) }}"></script>
@endpush
