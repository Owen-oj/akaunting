                ...
                <table class="table align-items-center table-flush">
                    <thead class="thead-light">
                        <tr class="row table-head-line">
                            ...
                            <th class="col-xs-4 col-md-2 text-left">{{ trans_choice('payroll::general.employees', 2) }}</th>
                    ...
                    <tbody>
                        @foreach($payrolls as $item)
                            <tr class="row border-top-1">
                                ...
                                <td class="col-xs-4 col-md-1 text-left"></td>
                                <td class="col-xs-4 col-md-1 text-left"></td>
                                <td class="col-xs-4 col-md-1 text-left"></td>
                                <td class="col-xs-4 col-md-2 text-left">{{ $item->employees->count() }}</td>
                                <td class="col-xs-4 col-md-2 text-left"><span class="label {{ $item->status_label }}">{{ trans('payroll::general.status.' . $item->status) }}</span></td>
